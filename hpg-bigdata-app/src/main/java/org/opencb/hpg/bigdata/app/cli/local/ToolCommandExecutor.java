...
public class ToolCommandExecutor extends CommandExecutor {
    ...
    private LocalCliOptionsParser.ToolCommandOptions toolCommandOptions;

    public ToolCommandExecutor(LocalCliOptionsParser.ToolCommandOptions toolCommandOptions) {
